    ...
    <div className={` flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 p px-6`}>
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <h1 className="fle-1 font-poppins font-semi-bold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
          Hey, I'm <br className="sm:block hidden" /> {" "}
          <span className="text-gradient">Ishrat Umar</span> {" "}
        </h1>
        <div className="ss:flex hidden md:mr-4 mr-0">
          <GetStarted />
        </div>
      </div>
      <h1 className="font-poppins font-semi-bold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full">Web Developer</h1>
